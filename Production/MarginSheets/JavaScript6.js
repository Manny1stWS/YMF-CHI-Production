...
function addHtmlTableRow() 
	{
		var newRow = table.insertRow(table.length),
			...
			LDP = '';
				if (poType === "STOCK" && trendZone === "NO") {

				LDP = ((((pricePerSqm * 100) * skuSqm * 1000) / 100000) + (((pricePerSqm * 100) * (skuSqm * 1000)) * 
				(dutyPercent * 100) / 1000000000) + ((parseInt(oceanFreight) + 500) / containerSqm * skuSqm));

				} else if (poType === "STOCK" && trendZone === "YES") {

				LDP = (((((pricePerSqm * 100) * skuSqm * 1000) / 100000) + (((pricePerSqm * 100) * (skuSqm * 1000)) * 
				(dutyPercent * 100) / 1000000000) + ((parseInt(oceanFreight) + 500) / containerSqm * skuSqm)) + 
				((pricePerSqm * 100) * (skuSqm * 1000) * 2)) / 100;

				} else if (poType === "POE" && trendZone === "NO") {

				LDP = ((((pricePerSqm * 100) * skuSqm * 1000) / 100000) + (((pricePerSqm * 100) * (skuSqm * 1000)) * 
				(dutyPercent * 100) / 1000000000) + (oceanFreight / containerSqm * skuSqm));

				} else if (poType === "POE" && trendZone === "YES") {
				...
				LDP = ((((pricePerSqm * 100) * skuSqm * 1000) / 100000) + (((pricePerSqm * 100) * (skuSqm * 1000)) * 
				(dutyPercent * 100) / 1000000000));

				} else if (poType === "MDDP" && trendZone === "YES") {

				LDP = (((((pricePerSqm * 100) * skuSqm * 1000) / 100000) + (((pricePerSqm * 100) * (skuSqm * 1000)) * 
				(dutyPercent * 100) / 1000000000))  + ((pricePerSqm * 100) * (skuSqm * 1000) * 2)) / 100;
				...
				LDP = ((((pricePerSqm * 100) * skuSqm * 1000) / 100000) * 102) / 100;
